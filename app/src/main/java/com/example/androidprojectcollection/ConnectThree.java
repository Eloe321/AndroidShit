...
public class ConnectThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(ConnectThree.this, "Christian Gelo D. Cadavos - CONNECT THREE", Toast.LENGTH_SHORT).show();
        StartProgram();

    }
    private void StartProgram(){
        GradientDrawable gradientDrawable = (GradientDrawable) getResources().getDrawable(R.drawable.gradient_btn);
        reset = (Button) findViewById(R.id.Reset);
        reset.setBackground(gradientDrawable);
    ...
    void EndGame(TextView p, ImageButton[][] b){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ConnectThree.this);
